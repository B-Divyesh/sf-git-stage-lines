# Non-interactive, line-range staging for git (and for coding agents) (`git-stage-lines`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://git-stage-lines.sociobot.in`. Artifact class: `cli`.
